...
app.factory('accelerometer', function ($rootScope, phonegapReady) {
    return {
...
app.factory('notification', function ($rootScope, phonegapReady) {
    return {
...
app.factory('compass', function ($rootScope, phonegapReady) {
    return {
...
app.factory('contacts', function ($rootScope, phonegapReady) {
    return {
